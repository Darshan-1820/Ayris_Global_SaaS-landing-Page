...
import POSHeroVisual from "@/components/assure-pos/POSHeroVisual";
import TypingText from "@/components/TypingText";
import { GridPattern } from "@/components/GridPattern";
import WhatIs_AssurePOS from "@/components/assure-pos/WhatIs_AssurePOS";
import Features_AssurePOS from "@/components/assure-pos/Features_AssurePOS";
import WhyAssurePOS from "@/components/assure-pos/WhyAssurePOS";
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="max-w-2xl">
                ...
                <h2 className="text-2xl lg:text-3xl font-semibold text-gray-700 mb-8 leading-tight">
                  Mobile SoftPOS simulator for <span className="text-blue-600">instant terminal testing.</span>
                </h2>
                
                {/* Typing Description */}
                <div className="text-lg text-gray-600 leading-relaxed mb-10 min-h-[5rem]">
                  <TypingText 
                    text="Test card and wallet transactions directly on a smartphone—without purchasing or configuring physical POS terminals."
                    speed={30}
                    delay={200}
                  />
                </div>
      ...
      <ScrollReveal>
        <section id="demo" className="py-24 bg-blue-50">
          <div className="container mx-auto px-6 lg:px-12 text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Start testing in minutes.</h2>
              <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                  Explore how Assure POS can accelerate your certification and QA workflows.
              </p>

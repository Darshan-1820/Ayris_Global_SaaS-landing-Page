...
import PaymentControlVisual from "@/components/assure-pay/PaymentControlVisual";
import TypingText from "@/components/TypingText";
import { GridPattern } from "@/components/GridPattern";
import WhatIs_AssurePay from "@/components/assure-pay/WhatIs_AssurePay";
import Features_AssurePay from "@/components/assure-pay/Features_AssurePay";
import WhyAssurePay from "@/components/assure-pay/WhyAssurePay";
import ScrollReveal from "@/components/ScrollReveal";

export default function AssurePAYPage() {
  return (
        ...
        <section id="demo" className="py-24 bg-blue-50">
          <div className="container mx-auto px-6 lg:px-12 text-center">
              ...
              <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                  Get a personalized consultation and see how Assure PAY can secure your payment ecosystem.
              </p>

export default function Footer() {
  return (
    <footer className="bg-black text-gray-400 py-16 border-t border-gray-900 font-light relative overflow-hidden">
       ...
       {/* Ambient Background Glow similar to Consulting/Features */}
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-white transition-colors duration-200">Assure PAT</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Assure PAY</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Assure POS</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-900 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
          ...
          <div className="flex gap-8">
            <a href="https://www.linkedin.com/company/ayris-global-llc/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200">LinkedIn</a>
          </div>
        </div>
      </div>
    </footer>
